...
WHERE
	ass.conclusion_date BETWEEN '2021-10-01' AND '2021-11-31' AND c.company_place_id != 3 AND ost.incident_type_id IN (1010, 1011, 1012, 1331, 1349, 1350) AND ost.incident_status_id = 4
GROUP BY
	ass.id
ORDER BY
	ass.conclusion_date