...
WHERE
	ca.activation_date BETWEEN '2022-03-01' AND '2022-05-31' AND c.company_place_id != 3 AND pv.financer_nature_id = 154/*  AND camp.campaign_id = 2 ----- AND pl.service_product_id = 2852*/
ORDER BY
	ca.activation_date