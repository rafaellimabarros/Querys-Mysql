...
WHERE
	prto.conclusion_date BETWEEN '2022-01-01' AND '2022-02-01' AND os.incident_type_id IN (1005, 1006, 10010, 1011, 1012, 1013, 1016, 1018, 1019, 1017, 1070, 1079, 1069, 1073) AND incident_status_id = 4 
GROUP BY
	p.name