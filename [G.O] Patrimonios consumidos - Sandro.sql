...
CASE WHEN pack.returned = 1 THEN 'Sim' ELSE 'Não' END AS teve_retorno
...
WHERE inv.financial_operation_id = 8 AND date(inv.created) BETWEEN '2022-07-16' AND '2022-07-31'
