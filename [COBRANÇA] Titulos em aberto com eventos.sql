...
WHERE
	...
	AND fat.expiration_date BETWEEN '2021-11-18' AND '2021-12-28'
...
/* SELECT * FROM financial_receivable_title_occurrences AS fev
WHERE fev.financial_title_occurrence_type_id = 5 */