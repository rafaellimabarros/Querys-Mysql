...
WHERE
	prto.conclusion_date BETWEEN '2021-12-10' AND '2021-12-11' AND os.incident_type_id IN (1005, 1006, 10010, 1011, 1012, 1013, 1016, 1018, 1019, 1017, 1070, 1079, 1069, 1073) AND incident_status_id = 4 -- 10010, 1011, 1012, 1013, 1016, 1018, 1019, 1017, 1070, 1079, 1069, 1073) 
GROUP BY
	p.name