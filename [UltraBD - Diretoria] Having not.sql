...
WHERE p.type_tx_id = 2 and a.assignment_type = 'INCI' AND c.contract_type_id != 4 AND c.company_place_id != 3 AND ai.incident_status_id != 8
GROUP BY p.id
HAVING NOT max(date(a.created)) BETWEEN '2021-01-01' AND '2022-03-31'
