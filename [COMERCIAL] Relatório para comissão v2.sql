...
LEFT JOIN 
	invoice_notes AS nf ON c.id = nf.contract_id AND nf.financer_nature_id = 103 AND nf.`status` = 1
LEFT JOIN
...
WHERE
	ca.activation_date BETWEEN '2022-04-01' AND '2022-05-31' AND c.company_place_id != 3	 /*  AND camp.campaign_id = 2 ----- AND pl.service_product_id = 2852*/
ORDER BY
	ca.activation_date
