...
WHERE
	ca.activation_date BETWEEN '2022-02-01' AND '2022-02-28' AND c.company_place_id != 3 AND c.contract_type_id IN (10, 11) /*  AND camp.campaign_id = 2 ----- AND pl.service_product_id = 2852*/
ORDER BY
	ca.activation_date